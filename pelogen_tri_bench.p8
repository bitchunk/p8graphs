...
add(tests, {len=273, author="shiftalow(hvb&ffff)", fn=function(i) local v=flattable[i] pelogen_tri_hvbaf(v[1],v[2],v[3],v[4],v[5],v[6],v[7]) end},1)
...
--by @shiftalow
-- 273 convert to integer with &0xffff
